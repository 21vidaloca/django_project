...
SECRET_KEY = 'django-insecure-!m*amsb*jkm6+u5r5$m1)rr+rzo@f*#4is4@o%l7xwsl^l93wt'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'aplicatie.context_processors.meniu_categorii',
            ],
        },
    },
]
...
EMAIL_PORT = 587 
EMAIL_USE_TLS = True 
EMAIL_HOST_USER = 'editingproject05@gmail.com'
EMAIL_HOST_PASSWORD = 'kjarqdzvynroffiy' # kjar qdzv ynro ffiy 
DEFAULT_FROM_EMAIL = 'vidaloca <editingproject05@gmail.com>'