...
urlpatterns = [
    ...
    path('contact/', views.afis_contact, name='contact'),
    path('termeni/', views.pagina_in_lucru, name='termeni'),
    path('cos-cumparaturi/', views.pagina_in_lucru, name='cos'),
    path('adaugare-produs/', views.adaugare_produs, name='adaugare_produs'),
    path('inregistrare/', views.inregistrare, name='inregistrare'),
    path('login/', views.login_view, name='login'),
    path('logout/', views.logout_view, name='logout'),
    path('profil/', views.profil_view, name='profil'),
    path('schimbare-parola/', views.schimbare_parola_view, name='schimbare_parola'),
    path('confirma_mail/<str:cod>/', views.view_confirma_mail, name='confirma_mail'),
]
